    ...
    <Card title="Fees & Insurance" icon={<DollarSign size={20} className="text-teal-600" />}>
      <div className="space-y-5 text-base">
        {(feeIndividual || feeCouples) && (
          <Section title="Session Fees" titleClassName="text-base font-semibold text-gray-700 mb-1.5">
        ...
        {(slidingScale !== undefined || freeConsultation !== undefined) && (
          <Section title="Affordability Options" titleClassName="text-base font-semibold text-gray-700 mb-1.5">
        ...
        {paymentsDisplay && (
          <Section title="Payment Methods" icon={<CreditCard size={16} className="mr-1.5 text-gray-500"/>} titleClassName="text-base font-semibold text-gray-700 mb-1.5">
            <p className="text-gray-700">{paymentsDisplay}</p>
          </Section>
        )}

        {insuranceDisplay && (
          <Section title="Insurance" icon={<FileText size={16} className="mr-1.5 text-gray-500"/>} titleClassName="text-base font-semibold text-gray-700 mb-1.5">
        ...
        {feeComment && feeComment.trim() !== '' && (
          <Section title="Additional Fee Information" titleClassName="text-base font-semibold text-gray-700 mb-1.5">
